...
require_once __DIR__ . "/ModuleSurveyJSView.php";
require_once __DIR__ . "/ModuleSurveyJSModel.php";
require_once __DIR__ . "/ModuleSurveyJSController.php";

/**
 * The class to define the asset select component.
 */
class ModuleSurveyJSComponent extends BaseComponent
{
    /* Constructors ***********************************************************/
